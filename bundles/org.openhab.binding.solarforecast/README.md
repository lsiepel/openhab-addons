...
`apiKey` can be provided if you subscribed to a paid plan.
...
| dampAM          | decimal | Damping factor for morning hours                                            | 0       | no       | true     |
| dampPM          | decimal | Damping factor for evening hours                                            | 0       | no       | true     |
